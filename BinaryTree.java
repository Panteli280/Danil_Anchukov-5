...
public class BinaryTree<T> implements DefaultBinaryTree<T> {
    ...
    class SimpleTreeNode implements DefaultBinaryTree.TreeNode<T> {
        public T value;
    ...
    public void printInorder(BinaryTree.SimpleTreeNode node) {
    ...
    public BinaryTree.SimpleTreeNode RemoveHalfNodes(BinaryTree.SimpleTreeNode node) {
        ...
        if (node.left == null) {
            BinaryTree.SimpleTreeNode new_root = node.right;
            return new_root;
        }

        if (node.right == null) {
            BinaryTree.SimpleTreeNode new_root = node.left;
            return new_root;
        }
